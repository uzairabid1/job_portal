...
if (move_uploaded_file($file_tmp_name, $destination_path)) {
    ...
    $query = mysqli_query($conn, "insert into job_apply (first_name,last_name,dob,file,id_job,job_seeker) VALUES ('$first_name', '$last_name', '$dob', '$file_name', '$id_job', '$job_seeker')");
    if ($query) { ?>
